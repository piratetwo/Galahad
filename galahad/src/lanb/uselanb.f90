...
!  Default values for specfile-defined parameters
     ...
     CHARACTER ( LEN = 30 ) :: vfilename = 'LANBSOLVEC.d'
...
!  solution-vector-file-name                LANBSOLVEC.d
...
!  End of module USELANB_double
    ...
    END MODULE GALAHAD_USELANB_double
