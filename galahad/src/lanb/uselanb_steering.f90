...
!-*-*-*-*-*-  L A N C E L O T  -B- USELANB _ S T E E R I N G   -*-*-*-*-*-*-*-
...
!   update released with GALAHAD Version 2.0. May 11th 2006
    ...
    MODULE GALAHAD_USELANB_steering_double
...
!  Specfile characteristics
     ...
     CHARACTER ( LEN = 16 ) :: specname = 'RUNLANB'
     TYPE ( SPECFILE_item_type ), DIMENSION( lspec ) :: spec
     CHARACTER ( LEN = 16 ) :: runspec = 'RUNLANB.SPC'
...
!  The default values for RUNLANB could have been set as:

! BEGIN RUNLANB SPECIFICATIONS (DEFAULT)
!  write-problem-data                       NO
!  problem-data-file-name                   LANB.data
!  problem-data-file-device                 26
!  write-solution                           YES
!  solution-file-name                       LANBSOL.d
!  solution-file-device                     62
!  write-result-summary                     YES
!  result-summary-file-name                 LANBRES.d
...
!  restart-data-file-name                   LANBSAVE.d
!  restart-data-file-device                 59
!  save-data-for-restart-every              0
! END RUNLANB SPECIFICATIONS
...
!                 ' possibly infeasible. ' )
 ...
 2310  FORMAT( A8, I6, 1X, A3, 1X, A5, '( ', L1, ' ', I2,' ', I1, ' ', I1,     &
               ' ', L1, ' ', L1, ' ', L1, ' ', I4, ' ', I4, ') ',     &
               3I8, I4,                                                        &
               /, A8,' time ',0P, F12.2, ' Final function value ', ES12.4 )
 ...
 2450  FORMAT( 16X, A8,'  problem name ', /, 16X, I8,                          &
 ...
 2990  FORMAT( ' ** Message from -USE_LANB-', /,                               &
               ' Allocation error (status = ', I0, ') for ', A )

!  End of subroutine USE_LANB

      END SUBROUTINE USE_LANB

!  End of module USELANB_double

    END MODULE GALAHAD_USELANB_steering_double
