...
!$ use omp_lib
   ...
   interface MA87_analyse
      module procedure MA87_analyse_single
   end interface

   interface MA87_factor
      module procedure MA87_factor_single
   end interface

   interface MA87_factor_solve
      module procedure MA87_factor_solve_one_single, &
                       MA87_factor_solve_mult_single
   end interface

   interface MA87_solve
      module procedure MA87_solve_one_single, MA87_solve_mult_single
   end interface

   interface MA87_sparse_fwd_solve
      module procedure MA87_sparse_fwd_solve_single
   end interface

   interface MA87_finalise 
      module procedure MA87_finalise_single
   end interface
...
subroutine MA87_analyse_single(n, ptr, row, order, keep, control, info)
   USE GALAHAD_SYMBOLS
  ...
  &     '   $GALAHAD/src/makedefs/packages for details.' )" )
   ...
   info%maxdepth = 0
   info%stat = 0
end subroutine MA87_analyse_single

subroutine MA87_factor_single(n, ptr, row, val, order, keep, control, info)
   USE GALAHAD_SYMBOLS
   integer, intent(in) :: n ! order of A
   integer, intent(in) :: row(:) ! row indices of lower triangular part
   integer, intent(in) :: ptr(:) ! col pointers for lower triangular part
...
end subroutine MA87_factor_single

subroutine MA87_factor_solve_one_single(n, ptr, row, val, order, keep, control,&
      info, x)
   USE GALAHAD_SYMBOLS
   integer, intent(in) :: n ! order of A
   integer, intent(in) :: row(:) ! row indices of lower triangular part
  ...
  &     ' If you have HSL (formerly the Harwell Subroutine', /,                &
  &     ' Library), this option may be enabled by replacing the dummy ', /,    &
  &     ' subroutine MA87_factor_solve_one with its HSL namesake ', /,         &
  &     ' and dependencies. See ', /,                                          &
  &     '   $GALAHAD/src/makedefs/packages for details.' )" )
   ...
   info%maxdepth = 0
   info%stat = 0
end subroutine MA87_factor_solve_one_single

subroutine MA87_factor_solve_mult_single(n, ptr, row, val, order, keep, &
  ...
  &     ' If you have HSL (formerly the Harwell Subroutine', /,                &
  &     ' Library), this option may be enabled by replacing the dummy ', /,    &
  &     ' subroutine MA87_factor_solve_mult with its HSL namesake ', /,        &
  &     ' and dependencies. See ', /,                                          &
  &     '   $GALAHAD/src/makedefs/packages for details.' )" )
   ...
   info%maxdepth = 0
   info%stat = 0
end subroutine MA87_factor_solve_mult_single
...
subroutine MA87_solve_one_single(x,order,keep,control,info,job)
  ...
  &     '   $GALAHAD/src/makedefs/packages for details.' )" )
   ...
   info%maxdepth = 0
   info%stat = 0
end subroutine MA87_solve_one_single

subroutine MA87_solve_mult_single(nrhs,lx,x,order,keep, control,info,job)
   USE GALAHAD_SYMBOLS
   integer, intent(in) :: nrhs ! number of right-hand sides to solver for.
   integer, intent(in) :: lx ! first dimension of x
   real(wp), intent(inout) :: x(lx,nrhs) ! On entry, x must
  ...
  &     '   $GALAHAD/src/makedefs/packages for details.' )" )
   ...
   info%maxdepth = 0
   info%stat = 0
end subroutine MA87_solve_mult_single

subroutine MA87_sparse_fwd_solve_single(nbi,bindex,b,order,invp,               &
  ...
  &     '   $GALAHAD/src/makedefs/packages for details.' )" )
   ...
   info%maxdepth = 0
   info%stat = 0
end subroutine MA87_sparse_fwd_solve_single

subroutine MA87_finalise_single(keep, control)
   USE GALAHAD_SYMBOLS
...
end subroutine MA87_finalise_single
