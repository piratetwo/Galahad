...
!-*-*-*-*-*-*-*-*-*-  U S E _ T R U   S U B R O U T I N E  -*-*-*-*-*-*-*-

     SUBROUTINE USE_TRU( input )
...
!  Specfile characteristics
     ...
     CHARACTER ( LEN = 16 ) :: specname = 'RUNTRU'
     TYPE ( SPECFILE_item_type ), DIMENSION( lspec ) :: spec
     CHARACTER ( LEN = 16 ) :: runspec = 'RUNTRU.SPC'
...
!    LOGICAL :: write_result_summary = .FALSE.
     ...
     CHARACTER ( LEN = 30 ) :: dfilename = 'TRU.data'
     CHARACTER ( LEN = 30 ) :: rfilename = 'TRURES.d'
     CHARACTER ( LEN = 30 ) :: sfilename = 'TRUSOL.d'
     CHARACTER ( LEN = 30 ) :: wfilename = 'TRUSAVE.d'
...
!  Set up control parameters prior to the next solution
     ...
     IF ( is_specfile ) CALL TRU_read_specfile( control, input_specfile )
...
!  End of subroutine USE_TRU
     ...
     END SUBROUTINE USE_TRU

!  End of module USETRU_double

   END MODULE GALAHAD_USETRU_double
